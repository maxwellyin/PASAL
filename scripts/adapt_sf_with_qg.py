...
from pasal.pseudo_labeling import filter_score_threshold, make_qg_extract_qa_pseudo_labeler
...
def parse_args():
    parser = argparse.ArgumentParser(description="Source-free adaptation with generated questions and an extractive QA pseudo-labeler.")
...
def main():
    ...
    pseudo_label_fn = make_qg_extract_qa_pseudo_labeler(args.qg_model, args.qa_checkpoint)
