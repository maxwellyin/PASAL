...
model_checkpoint = f"./checkpoint/prompt-{model_name}-{SOURCE_DOMAIN}/prompt-sf/{TARGET_DOMAIN}/final/0"
...
def train(train_dataset, validation_dataset, model):
    ...
    args = Seq2SeqTrainingArguments(
        output_dir=f"./checkpoint/prompt-{model_name}-{SOURCE_DOMAIN}/m-sf-after-p-sf",
...
for i in range(1):
    ...
    model.save_pretrained(f"./checkpoint/prompt-{model_name}-{SOURCE_DOMAIN}/m-sf-after-p-sf/{i}")
