...
model_checkpoint = f"./checkpoint/prompt-{model_name}-{SOURCE_DOMAIN}/12/final"
...
def train(train_dataset, validation_dataset, model):
    ...
    args = Seq2SeqTrainingArguments(
        output_dir=f"./checkpoint/prompt-{model_name}-{SOURCE_DOMAIN}/13/{TARGET_DOMAIN}",
...
for i in range(1):
    ...
    model.save_pretrained(f"./checkpoint/prompt-{model_name}-{SOURCE_DOMAIN}/13/{TARGET_DOMAIN}/{i}")
