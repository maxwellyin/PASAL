...
# %%
import argparse 
parser = argparse.ArgumentParser(description='Specify TARGET_DOMAIN for the script.')
parser.add_argument('--target_domain', type=str, required=True, help='The target domain to be used.')
